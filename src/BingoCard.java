...
public class BingoCard {
     ...
     */
        ...
        for (arrayRows = 0; arrayRows < numbers.length; ++arrayRows) {
            for (arrayColumns = 0; arrayColumns < numbers[arrayRows].length; ++arrayColumns) {
                markedOff[arrayRows][arrayColumns] = false;
            }
        }
    ...
    */
     ...
     */
        ...
        for (arrayRows = 0; arrayRows < numbers.length; ++arrayRows) {
            for (arrayColumns = 0; arrayColumns < numbers[arrayRows].length; ++arrayColumns) {
                ...
                if (arrayColumns == numberOfColumns - 1) {
                    if (String.valueOf(numbers[arrayRows][arrayColumns]).length() == 1) {
                        sb.append(Defaults.getNumberSeparator());
                        sb.append(Defaults.getNumberSeparator());
                    } else {
                        sb.append(Defaults.getNumberSeparator());
                    }
                    sb.append(numbers[arrayRows][arrayColumns]);
                    sb.append("\n");
                } else if (arrayColumns == 0) {
                    if (String.valueOf(numbers[arrayRows][arrayColumns]).length() == 1) {
                        sb.append(Defaults.getNumberSeparator());
                    }
                    sb.append(numbers[arrayRows][arrayColumns]);
     ...
     */
        ...
        int arrayRows = getNumberOfRows();
        int arrayColumns = getNumberOfColumns();
        int numListArrPos = 0;

        numbers = new int[arrayRows][arrayColumns];


        for (arrayRows = 0; arrayRows < numbers.length; ++arrayRows) {
            for (arrayColumns = 0; arrayColumns < numbers[arrayRows].length; ++arrayColumns) {
                numbers[arrayRows][arrayColumns] = numbersList[numListArrPos];
                ++numListArrPos;
            }
        }
     ...
     */
        ...
        for (arrayRows = 0; arrayRows < numbers.length; ++arrayRows) {
            for (arrayColumns = 0; arrayColumns < numbers[arrayRows].length; ++arrayColumns) {
                if (number == numbers[arrayRows][arrayColumns]) {
                    markedOff[arrayRows][arrayColumns] = true;
                    valueFound = true;
     ...
     */
        ...
        for (arrayRows = 0; arrayRows < markedOff.length; ++arrayRows) {
            for (arrayColumns = 0; arrayColumns < markedOff[arrayRows].length; ++arrayColumns) {
                if (!markedOff[arrayRows][arrayColumns]) {
                    winner = false;
                    break;
                }
            }
